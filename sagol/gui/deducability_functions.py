...
def deduce_by_leave_one_roi_out(parent, model_name):
...
def deduce_by_coefs_or_from_bagging_regressor(parent, model_name):
    ...
    model_importances = ded_by_coefs(models={model_name: trained_models.models[model_name]},
                                     first_index_of_contrast=(-1)*len(trained_models.reverse_contrast_mapping),
...
DEDUCABILITY_CREATORS = {'deduce_by_leave_one_roi_out': deduce_by_leave_one_roi_out, 'deduce_by_coefs': deduce_by_coefs, 'deduce_from_bagging_regressor': deduce_from_bagging_regressor}

DEDUCABILITY_NAMES = {'deduce_by_leave_one_roi_out': 'ROIs importance',
                      'deduce_by_coefs': 'Voxel importance',
